/*
 * FullAPI reference: MatterLaundryDryer
 *
 ...
 *
 * MatterLaundryDryer is one of the OperationalState trio
 ...
 * MatterLaundryWasher/MatterDishwasher siblings are therefore identical
 ...
 *
 *   MatterLaundryDryer()        global object below
 ...
 *   if (!Dryer.setOperationalState(MatterLaundryDryer::kStateRunning)) {
...
void loop() {
  ...
  if (Serial.available()) {
    switch (Serial.read()) {
      case '1':
        Serial.println(Dryer.setOperationalState(MatterLaundryDryer::kStateRunning) ? "setOperationalState(Running): OK" : "setOperationalState(Running): failed");
        break;
      case '2':
        Serial.println(Dryer.setOperationalState(MatterLaundryDryer::kStatePaused) ? "setOperationalState(Paused): OK" : "setOperationalState(Paused): failed");
        break;
      case '0':
        Serial.println(Dryer.setOperationalState(MatterLaundryDryer::kStateStopped) ? "setOperationalState(Stopped): OK" : "setOperationalState(Stopped): failed");
        break;
      case 'e':
        Serial.println(Dryer.setOperationalState(3) ? "setOperationalState(3): OK (unexpected)" : "setOperationalState(3): failed (expected; Error is reserved)");
        break;
      case 's': Serial.print("operationalState: "); Serial.println(Dryer.getOperationalState()); break;

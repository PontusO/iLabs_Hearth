/*
 * MatterRainSensor.h - a boolean-state sensor.
 *
 * Mirrors arduino-esp32's Matter library MatterRainSensor (see
 * ~/.arduino15/packages/esp32/hardware/esp32/3.3.8/libraries/Matter/src/MatterEndpoints/MatterRainSensor.h):
 * the public section below is reproduced verbatim, protected members
 * included. Device type 0x0044 is rain_sensor, cluster 0x0045 is BooleanState,
 ...
 *
 * begin() calls hearthDeclare(this, 0x0044) and caches initialState. It
 ...
 * are a Hearth addition, not present in upstream's MatterRainSensor.h
 * public section. Every boolean-state sensor in this library (also
 * MatterContactSensor, MatterWaterFreezeDetector, MatterWaterLeakDetector)
